...
class Soldier(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # Regen health logic - AI
        if (self.alive and 
            self.health < self.max_health and
            pygame.time.get_ticks() - self.last_damage_time > 3000):  # 3s delay
            self.regen_timer += 1
            if self.regen_timer >= 60:  # 1HP/sec at 60FPS
    ...
    # New function for taking damage - to use better with regen health
